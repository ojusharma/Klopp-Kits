...
UPDATE Product SET productImageURL = 'img/arsh.jpg' WHERE ProductId = 1;
UPDATE Product SET productImageURL = 'img/whmh.JPG' WHERE ProductId = 2;
UPDATE Product SET productImageURL = 'img/livh.jpg' WHERE ProductId = 3;
UPDATE Product SET productImageURL = 'img/mcih.jpg' WHERE ProductId = 4;
UPDATE Product SET productImageURL = 'img/munh.jpeg' WHERE ProductId = 5;
UPDATE Product SET productImageURL = 'img/rmh.jpeg' WHERE ProductId = 6;
UPDATE Product SET productImageURL = 'img/barh.jpeg' WHERE ProductId = 7;
UPDATE Product SET productImageURL = 'img/atmh.jpeg' WHERE ProductId = 8;
UPDATE Product SET productImageURL = 'img/geth.jpg' WHERE ProductId = 9;
UPDATE Product SET productImageURL = 'img/girh.jpeg' WHERE ProductId = 10;
UPDATE Product SET productImageURL = 'img/fcbh.jpg' WHERE ProductId = 11;
UPDATE Product SET productImageURL = 'img/doth.jpg' WHERE ProductId = 12;
UPDATE Product SET productImageURL = 'img/frkh.jpg' WHERE ProductId = 13;
UPDATE Product SET productImageURL = 'img/hsvh.jpg' WHERE ProductId = 14;
UPDATE Product SET productImageURL = 'img/h96h.jpg' WHERE ProductId = 15;
UPDATE Product SET productImageURL = 'img/mumh.jpg' WHERE ProductId = 16;
UPDATE Product SET productImageURL = 'img/kerh.jpg' WHERE ProductId = 17;
UPDATE Product SET productImageURL = 'img/goah.jpg' WHERE ProductId = 18;
UPDATE Product SET productImageURL = 'img/neuh.jpg' WHERE ProductId = 19;
UPDATE Product SET productImageURL = 'img/chnh.jpg' WHERE ProductId = 20;
UPDATE Product SET productImageURL = 'img/psgh.jpg' WHERE ProductId = 21;
UPDATE Product SET productImageURL = 'img/lilh.jpg' WHERE ProductId = 22;
UPDATE Product SET productImageURL = 'img/OMRH.jpg' WHERE ProductId = 23;
UPDATE Product SET productImageURL = 'img/monh.jpg' WHERE ProductId = 24;
UPDATE Product SET productImageURL = 'img/olyh.jpg' WHERE ProductId = 25;
