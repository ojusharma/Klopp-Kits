...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Kerala Blasters FC Jersey 23/24', 4, 'Embrace the legacy of Kerala Blasters with our official 2023-2024 edition jersey, a symbol of pride for every devoted fan. A FREE FILTER COFFEE TOO!',10.00);
...
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password, isAdmin) VALUES ('Arnold', 'Anderson', 'a.anderson@gmail.com', '204-111-2222', '103 AnyWhere Street', 'Winnipeg', 'MB', 'R3X 45T', 'Canada', 'arnold' , '304Arnold!', 1);
